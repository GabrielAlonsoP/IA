...
//---------------------------------------------------------------- Background interactivo de Respuestas -----------------------------------------------//

// // Obtener referencia al textarea y al div de output
// const consultaTextarea = document.getElementById('mensaje');
// const respuestaOutput = document.getElementById('outputText');

// // Agregar evento al textarea para detectar cambios
// consultaTextarea.addEventListener('input', () => {
//     // Obtener el texto actual del textarea
//     const consulta = consultaTextarea.value.trim();

//     // Simular la generación de la respuesta (puedes reemplazar esto con tu lógica real)
//     const respuesta = generarRespuesta(consulta);

//     // Actualizar el contenido del div de output
//     respuestaOutput.textContent = respuesta;

//     // Actualizar el fondo del div de output (puedes ajustar según tus necesidades)
//     respuestaOutput.style.backgroundColor = 'red'; // Cambiar color de fondo
// });

// // Función de ejemplo para generar la respuesta (reemplázala con tu lógica real)
// function generarRespuesta(consulta) {
//     if (consulta === '') {
//         return 'Por favor, escribe una consulta válida.';
//     } else {
//         return 'Respuesta a la consulta: ' + consulta;
//     }
// }
